...
// Creates a new LookupError reference and returns it
...
func ParseSMTPError(err error) *LookupError {
	...
	if status > 400 {
		// Don't return an error if the error contains anything about the address being undeliverable
...
// Parses a basic MX record response and returns a more understandable LookupError
...
// Returns true if any of the substrings are found in the past string
// This method of checking contains is case-insensitive
